        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinApprovalRequired = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PaymentTermsType = table.Column<int>(type: "int", nullable: true),
                    Stage = table.Column<int>(type: "int", nullable: false),
                    ApDownPaymentInvoiceEntryNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
...
INSERT INTO AspNetRoles ( Name, NormalizedName, ConcurrencyStamp)
VALUES ( 'SuperAdmin', 'SUPERADMIN', NEWID());

INSERT INTO AspNetRoles ( Name, NormalizedName, ConcurrencyStamp)
VALUES ( 'Standard', 'STANDARD', NEWID());
");
        }
