namespace SapApi.Modals.Responses.Sap
{
    ...
    {
        [JsonPropertyName("AbsoluteEntry")] public int AbsoluteEntry { get; set; }
        [JsonPropertyName("DocumentNumber")] public int DocumentNumber { get; set; }
        ...
        [JsonPropertyName("PlannedQuantity")] public double PlannedQuantity { get; set; }

        [JsonPropertyName("CompletedQuantity")]
        public double CompletedQuantity { get; set; }

        [JsonPropertyName("RejectedQuantity")] public double RejectedQuantity { get; set; }
        [JsonPropertyName("PostingDate")] public DateTime PostingDate { get; set; }
    ...
    {
        [JsonPropertyName("DocumentAbsoluteEntry")]
        ...
        [JsonPropertyName("BaseQuantity")] public double BaseQuantity { get; set; }

        [JsonPropertyName("PlannedQuantity")] public double PlannedQuantity { get; set; }

        [JsonPropertyName("IssuedQuantity")] public double IssuedQuantity { get; set; }
        ...
        [JsonPropertyName("LocationCode")] public int LocationCode { get; set; }
