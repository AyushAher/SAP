...
/// <summary>
/// Local mirror of a SAP Business One Purchase Request (OPRQ) header.
/// SAP remains the write authority; this table serves reads/reporting after sync.
/// </summary>
public class PurchaseRequest : ISoftDeletable
{
    ...
    /// <summary>SAP OPRQ.Requester — user code when ReqType is 12.</summary>
    ...
    public ICollection<PurchaseRequestPaymentTerm> PaymentTerms { get; set; } = [];
}

public class PurchaseRequestLine : ISoftDeletable
{
    public int Id { get; set; }
    public bool IsDeleted { get; set; }
...
public class PurchaseRequestPaymentTerm : ISoftDeletable
{
    public int Id { get; set; }
    public bool IsDeleted { get; set; }
    public int PurchaseRequestId { get; set; }
...
/// <summary>Per-company sync metadata for purchase requests (including Hangfire full-sync job).</summary>
public class PurchaseRequestSyncState : ISoftDeletable
{
