...
{
    public static void ApplyHeader(PurchaseRequest entity, SapPurchaseRequestsResponse sap, DateTime syncedAtUtc)
    {
        ...
        entity.Requester = sap.Requester;
        entity.RequesterName = sap.RequesterName;
        entity.RequesterEmail = sap.RequesterEmail;
        entity.ReqCode = sap.ReqCode;
        entity.ReqType = sap.ReqType;
        entity.RequesterDepartment = sap.RequesterDepartment;
        entity.RequesterBranch = sap.RequesterBranch;
        entity.RequiredDate = sap.RequiredDate ?? sap.DocDueDate ?? sap.DueDate;
        entity.Cancelled = sap.Cancelled;
    ...
    public static List<PurchaseRequestLine> MapLines(int purchaseRequestId, IEnumerable<SapInventoryTransferItemsRequests>? lines)
    {
        if (lines is null)
            return [];

        return lines.Select((line, index) => new PurchaseRequestLine
        {
    ...
    public static List<PurchaseRequestPaymentTerm> MapPaymentTerms(int purchaseRequestId, SapPurchaseRequestsResponse sap)
    {
        return sap.CreateUdfList()
            ...
            .Select(t => new PurchaseRequestPaymentTerm
            {
                PurchaseRequestId = purchaseRequestId,
                Slot = t.Id!.Value,
    ...
    public static SapPurchaseRequestsResponse ToSapResponse(PurchaseRequest entity, bool includeLines)
    {
        var response = new SapPurchaseRequestsResponse
        {
            ...
            ReqType = entity.ReqType,
            RequesterDepartment = entity.RequesterDepartment,
            RequesterBranch = entity.RequesterBranch,
    ...
    private static void ApplyPaymentTermSlots(
        SapPurchaseRequestsResponse response,
        IEnumerable<PurchaseRequestPaymentTerm> terms)
    {
