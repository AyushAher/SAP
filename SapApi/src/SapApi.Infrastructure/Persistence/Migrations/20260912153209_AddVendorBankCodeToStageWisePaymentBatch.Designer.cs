...
namespace SapApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912153209_AddVendorBankCodeToStageWisePaymentBatch")]
    partial class AddVendorBankCodeToStageWisePaymentBatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.ActionAuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.ProductionOrder", b =>
                {
                    ...
                    b.Property<int?>("AttachmentEntry")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DistributionRule")
                        .HasColumnType("text");

                    b.Property<string>("DistributionRule2")
                        .HasColumnType("text");

                    b.Property<string>("DistributionRule3")
                        .HasColumnType("text");

                    b.Property<string>("DistributionRule4")
                        .HasColumnType("text");

                    b.Property<string>("DistributionRule5")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsVirtualSubassembly")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<int?>("ParentAbsoluteEntry")
                        .HasColumnType("integer");

                    b.Property<string>("ParentProductionOrderNo")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("PickRemarks")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ProductionCategory")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("ProductionOrderOrigin")
                        .HasMaxLength(32)
                    ...
                    b.Property<string>("RoutingDateCalculation")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("UpdateAllocation")
                        .HasColumnType("text");

                    b.Property<int?>("UserSignature")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CompanyDb", "AbsoluteEntry")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.HasIndex("CompanyDb", "CustomerCode");

                    b.HasIndex("CompanyDb", "DocumentNumber");

                    b.HasIndex("CompanyDb", "ItemNo");

                    b.HasIndex("CompanyDb", "ParentAbsoluteEntry");

                    b.HasIndex("CompanyDb", "ParentProductionOrderNo");

                    b.HasIndex("CompanyDb", "Project");

                    b.HasIndex("CompanyDb", "SalesOrderDocNum");

                    b.HasIndex("CompanyDb", "Status");

                    b.ToTable("ProductionOrders");
                });

            modelBuilder.Entity("SapApi.Domain.Entities.ProductionOrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("AdditionalQuantity")
                        .HasColumnType("double precision");
                    ...
                    b.Property<string>("ProductionOrderIssueType")
                        .HasColumnType("text");
                    ...
                    b.Property<double?>("RequiredDays")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.ProductionOrderSyncLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CompanyDb", "CreatedOn");

                    b.ToTable("ProductionOrderSyncLogs");
                });

            modelBuilder.Entity("SapApi.Domain.Entities.ProductionOrderSyncState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("LastAbsoluteEntry")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProductionOrderSyncStates");
                });
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RequesterBranch")
                        .HasColumnType("integer");

                    b.Property<int?>("RequesterDepartment")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.PurchaseRequestLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PurchaseRequestId", "LineNum")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.PurchaseRequestPaymentTerm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PurchaseRequestId", "Slot")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("PurchaseRequestPaymentTerms");
                });

            modelBuilder.Entity("SapApi.Domain.Entities.PurchaseRequestSyncState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PurchaseRequestSyncStates");
                });
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.ProductionOrderLine", b =>
                {
                    b.HasOne("SapApi.Domain.Entities.ProductionOrder", "ProductionOrder")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("SapApi.Domain.Entities.PurchaseRequestLine", b =>
                {
                    b.HasOne("SapApi.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithMany("Lines")
