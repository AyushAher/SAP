        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompressedValue = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StageWisePayments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PaymentTermsType = table.Column<int>(type: "integer", nullable: true),
                    Stage = table.Column<int>(type: "integer", nullable: false),
                    StageDesc = table.Column<string>(type: "text", nullable: true),
                    Bank = table.Column<string>(type: "text", nullable: true),
                    UtrNo = table.Column<string>(type: "text", nullable: true),
                    UtrDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    ApDownPaymentInvoiceEntryNumber = table.Column<string>(type: "text", nullable: true),
                    WtCode = table.Column<string>(type: "text", nullable: true),
                    GrossAmount = table.Column<double>(type: "double precision", nullable: true),
                    GstAmount = table.Column<double>(type: "double precision", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StageWisePayments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ApprovalPolicyId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApprovalPolicyApprovers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportingData = table.Column<string>(type: "text", nullable: true),
                    FailureReason = table.Column<string>(type: "text", nullable: true),
                    SapResponseDocNum = table.Column<string>(type: "text", nullable: true),
                    SapResponseDocEntry = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserApprovals_ApprovalRequests_ApprovalRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApprovals_ApprovalRequestId",
                table: "UserApprovals",
